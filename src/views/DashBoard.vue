...
<template>
    <div class="bgImg h-full p-5 padding1 paddingTop login">
        <div class="slidedown animation-iteration-1 animation-duration-1000 lg:p-5 md:p-4 sm:p-3 padding1 lg:w-7 md:w-9 sm:w-10 widthFull my-5 m-auto flex flex-column justify-content-center" style="background-color: rgba(255, 255, 255, 0.591); border-radius: 5px;">
            <h1 class="text-center font21 padding1 fontt lg:pt-5">Welcome To Life Formula DashBoard</h1>
