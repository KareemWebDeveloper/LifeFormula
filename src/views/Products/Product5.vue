...
<ContactIcons></ContactIcons>
    ...
    <div class="scalein animation-duration-2000 animation-iteration-1 p-2 lg:p-5 flex FlexColumnMob lg:flex-row md:flex-column sm:flex-column">
        ...
        <div class="w-9 m-auto lg:m-0 sm:text-center md:text-center lg:text-left textCenterMob width90">
            ...
            <p class="w-10 my-3 darkGrey sm:m-auto md:m-auto lg:m-0 MargAutoMob textJustifyMob">Life Formula's WFS MAX is a natural supplement that can help women with fertility
                problems. It contains ingredients that improve insulin sensitivity and ovulation, two
                important factors for conception. <br>
                ● D-Chiro-Inositol: This is an amino acid that helps the body use insulin more
                effectively. When insulin is not working properly, it can lead to problems with
                fertility. D-Chiro-Inositol has been shown to improve insulin sensitivity in women
                with polycystic ovary syndrome (PCOS), a condition that can cause infertility.<br>
                ● N-Acetylcysteine: This is an antioxidant that helps protect the body from damage
                caused by free radicals which are unstable molecules that can damage cells and
                tissues causing a number of health problems, including infertility. N-
                Acetylcysteine helps to neutralize free radicals and protect the body from their
                harmful effects.<br>
                ● Antioxidant blend: This blend contains a variety of antioxidants which help protect
                the body from damage caused by free radicals. They are essential for overall
                health and well-being and play a role in fertility.
            </p>
            <div class="flex FlexColumn sm:flex-column md:flex-column MargAutoMob lg:flex-row my-4 align-items-center lg:justify-content-between w-10 sm:m-auto md:m-auto lg:m-0">
                ...
                decrementButtonClassName="p-button-secondary" incrementButtonClassName="p-button-secondary" incrementButtonIcon="pi pi-plus"
                 ...
                 <h5 class="p-3 px-5 m-0 flex align-items-center AddToCart text-center justify-content-center" @click="isDialogVisible = true">ADD TO CART <span class="material-symbols-outlined text-2xl mx-1 cursor-pointer">
                    shopping_cart
                </span>
                </h5>
            </div>
            <p class="sm:text-center md:text-center lg:text-left">Price : {{(QuantityValue * 26.99).toFixed(2)}}$</p>
            ...
            <div class="w-10 text-center sm:m-auto md:m-auto lg:m-0  mgAuto" v-if="OptionsValue=='HOW TO TAKE IT'">
                <p>Take 6 capsules daily. For best results, take two capsules, three times a day, after meals. Drink
                    6 to 8 glasses of water per day</p>
            </div>
            <div class="w-10 text-center flex justify-content-center sm:m-auto md:m-auto lg:m-0 mgAuto" v-if="OptionsValue=='INGREDIENTS'">
                <img src="../../assets/d310000_ingredients.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="productIcons p-5 w-full flex flex-wrap justify-content-center mt-5">
            <div class="text-center mx-3 my-3">
                ...
                <h2 class="productIconsFont">Improved Insulin Sensitivity</h2>
            </div>
            ...
            <div class="text-center mx-3 my-3">
                ...
                <h2 class="productIconsFont">Improved Ovulation</h2>
            </div>
            <div class="hidden lg:flex">
                <Divider layout="vertical" />
            </div>
            <div class="text-center mx-3 my-3">
                ...
                <h2 class="productIconsFont">Improved Overall Wellbeing</h2>
            </div>
    </div>
